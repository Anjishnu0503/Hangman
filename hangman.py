...
word = [
    ...
    'grapefruit', 'jalapeño', 'kumquat', 'lime', 'melon',
    'nectar', 'olive', 'peach', 'quinoa', 'rhubarb',
    'soursop', 'tomato', 'ugli', 'voavanga', 'wolfberry',
    'ximenia', 'yellowberry', 'ziziphus', 'apricot', 'blackberry',
    'cabbage', 'daikon', 'endive', 'fennel', 'garlic',
    'horseradish', 'jalapeño', 'kale', 'lettuce', 'mushroom',
    'navybean', 'onion', 'parsley', 'quinoa', 'radish',
    'spinach', 'turnip', 'utahraptor', 'vanillabean', 'wasabi',
    'yam', 'zucchini', 'basil', 'cilantro', 'dill',
    'tarragon', 'chives', 'thyme', 'oregano', 'sage',
    'rosemary', 'pepper', 'carrot', 'beet', 'cauliflower'
]
